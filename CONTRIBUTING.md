...
This folder will consume approx. 5 GB of disk space. To keep the fixture somewhere else, set `GITVMR_BENCH_FIXTURE_DIR` to the target directory before running the benchmark. Remove the default fixture with:
