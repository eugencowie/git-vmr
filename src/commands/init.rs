...
pub fn init(working_dir: &Path, args: &InitArgs) -> Result<Rendered>
{
...
mod tests
{
    ...
    fn creates_config_directory_and_file()
    {
        ...
        // Act
        init(tmp.path(), &InitArgs { directory: None }).unwrap();
    ...
    fn creates_config_in_absolute_target_directory()
    {
        ...
        // Act
        init(Path::new("/ignored"), &InitArgs {
    ...
    fn errors_when_target_exists_as_file()
    {
        ...
        // Act
        let err = init(tmp.path(), &InitArgs {
