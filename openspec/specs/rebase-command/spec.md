# rebase-command Specification

## Purpose
Define how `git vmr rebase` rebases immediate child Git repositories in a VMR onto a requested upstream while preserving Git's per-repository rebase behavior, reporting repository-specific failures deterministically, and respecting existing VMR root discovery rules.
