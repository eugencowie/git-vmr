# cli-error-rendering Specification

## Purpose
Define how `git-vmr` renders direct command errors and aggregate fan-out failures so user-facing output preserves explicit `fatal:` and `error:` prefixes without top-level rewriting.
