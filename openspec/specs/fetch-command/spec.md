...
## Purpose
Define `git vmr fetch [<repository> [<refspec>...]]` behavior for fetching across immediate child repositories in a virtual monorepo, including Git-delegated argument handling, best-effort execution, deterministic reporting, and existing VMR working directory handling.
