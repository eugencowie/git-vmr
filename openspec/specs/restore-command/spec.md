# restore-command Specification

## Purpose
Define `git vmr restore` behavior for discarding tracked changes across child repositories from any working directory inside a virtual monorepo, including staged and worktree targets, path routing, validation, root expansion, and Git failure reporting.
