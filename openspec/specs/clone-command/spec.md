...
## Purpose
Define `git vmr clone` behavior for delegating repository cloning to Git from the effective working directory, including optional destination handling, `-C` support, operation outside VMR metadata, and preservation of Git process behavior.
