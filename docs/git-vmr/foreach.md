...
| ------- | ----------- | ---------- |
| add \[-b \<branch\>\] \[-f\\|--force\] \[--name \<name\>\] \[--reference \<repository\>\] \[--ref-format \<format\>\] \[--depth \<depth\>\] \[--\] \<repository\> \[\<path\>\] | Add the given repository as a submodule at the given path to the changeset to be committed next to the current project: the current project is termed the "superproject". | ❌ |
